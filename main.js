...
function putInTeachers() {
    ...
    for (let i = 0; i < teachers.length; i++) {
        html_ += "<option data-tokens='" + teachers_id[i] +  " " + teachers[i] +  " " + teachers_subj[i] + " value='" + teachers[i] + "'>" + teachers[i] + "</option>"
